            ...
            data.forEach((item, index) => {
                ...
                card.innerHTML = `
                    <div class="card skillsText">
                        <div class="card-body">
                            <img src="./images/${item.image}" alt="Capture d'écran du projet ${item.title}" loading="lazy" decoding="async">
        ...
        .then((data) => {
            ...
            data.forEach((item, index) => {
                ...
                card.innerHTML = `
                    ...
                    <img class="card-img-top" src="images/${item.image}" alt="Capture d'écran du projet ${item.title}" loading="lazy" decoding="async" style="width:100%">
                    <div class="card-body">
